...
public class MouseControl : MonoBehaviour { 			// MouseControl Script
	...
	void FixedUpdate () {													// FixedUpdate Function
		this.gameObject.transform.position = Input.mousePosition;			// this game object's transform position is equal to the position of the mouse
		rb.transform.position = Input.mousePosition;						// this game object's rigidbody position is equal to the position of the mouse
